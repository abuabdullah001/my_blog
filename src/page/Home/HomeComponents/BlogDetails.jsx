                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
                                <span className="w-2 h-7 bg-secondary rounded-full"></span>
                                কারিকুলাম (Curriculum)
                            </h2>
                            <div className="space-y-4">
                                {blogData.curriculum?.map((module, idx) => (
                                    <div key={idx} className="collapse collapse-arrow bg-base-200 border border-base-300 rounded-2xl">
                                        ...
                                        <div className="collapse-title flex items-center justify-between pr-10">
                                            <div className="flex flex-col">
                                                <span className="text-primary font-bold text-sm uppercase">{module.subtitle}</span>
                                                <span className="text-lg font-bold">{module.title}</span>
                                            </div>
                                            <div className="badge badge-outline">{module.total_classes} Classes</div>
                                        </div>
                                        <div className="collapse-content space-y-4">
                                            {module.topics?.map((topic, tidx) => (
                                                <div key={tidx} className="p-4 bg-base-100 rounded-xl border border-base-300">
                                                    <div className="flex justify-between items-start mb-2">
                                                        <h4 className="font-bold text-primary">Week {topic.week}: {topic.title}</h4>
                                                        {topic.is_preview && <span className="badge badge-success badge-sm text-white">Preview</span>}
                                                    </div>
                                                    {topic.lessons && (
